...
import com.bydlopz.numbercompositiongame.data.GameRepositoryImpl
import com.bydlopz.numbercompositiongame.domain.entity.GameResult
...
import com.bydlopz.numbercompositiongame.domain.usecases.GenerateQuestionUseCase
import com.bydlopz.numbercompositiongame.domain.usecases.GetGameSettingsUseCase

class GameViewModel(private val application: Application, private val level: Level) :
    ViewModel() {
